...
1. **BackOffice**: Contiene tutti gli strumenti necessari affinché i creator possano assemblare le loro **collection**.
...
**Nota**: In **BackOffice**, l'insieme degli item che costituiscono gli **EGI** (Elemento Grafico Identificativo) è chiamato **collection**. Nel **Marketplace**, la stessa entità è chiamata **galleria**.

---

## Indice dei Moduli di Office

1. [Make Collection](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#make-collection)
2. [Make Item](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#make-item)
3. [Make Traits](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#make-traits)
4. [Make Team](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#make-team)
5. [Make Wallet](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#make-wallet)
6. [Make EPP](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#make-epp)
7. [Make Utilities](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#make-utilities)
8. [Make Drop](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#make-drop)
9. [Biographies Builder](https://chatgpt.com/c/6732c58b-702c-8006-91e0-fd551eef85fd#biographies-builder)
10. [Notifications](20250611%20Flusso%20v.3.md)
...
- **EPP Associato**: L'Enviromental Protection Program scelto.
...
La tua proposta mi sembra **equilibrata e strategica**! Con il **6% totale**, hai trovato il giusto compromesso tra sostenibilità economica, responsabilità ambientale e incentivazione per i Creator. Ecco una sintesi della tua policy e un'idea di come presentarla in modo preciso:

---

### **Policy delle Royalties nel Rebind (Mercato Secondario)**

#### **Percentuali di Default**

- **Creator**: **5%**
    - Questa percentuale rappresenta la royalty standard per i Creator. Tuttavia, il Creator ha la possibilità di ridurla fino al **1%** per destinare il restante alla causa ambientale supportata dall'EPP.
    - **Range modificabile dal Creator**: **1% - 5%**.
- **EPP (Environment Protection Program)**: 1%**
    - Percentuale sempre garantita per il supporto ai programmi ambientali, con la possibilità di aumentare fino a **5%** grazie alla riduzione volontaria della quota del Creator.
- **Piattaforma (Natan)**: **1%**
    - Percentuale fissa, destinata a garantire la sostenibilità della piattaforma e lo sviluppo di nuove funzionalità.

#### **Totale Rebind Fee**: **7%**

- Questa è la quota complessiva trattenuta da ogni transazione nel mercato secondario.

---

### **Funzionalità e Incentivi**

1. **Sacrificio Etico del Creator**:
    
    - I Creator possono scegliere di ridurre la loro percentuale tramite un’apposita interfaccia nella dashboard.
    - Per ogni percentuale sacrificata, il corrispettivo aumenta automaticamente la quota destinata all’EPP.
    - Es. Creator sceglie **3%** (riduzione di 1,5%): l’EPP passa a **2,3%**.
2. **Visibilità e Badge**:
    
    - Creator che sacrificano parte della loro quota ricevono badge etici visibili sulle loro collezioni (es. "Supporter degli EPP").
    - Questo può anche diventare un filtro nel marketplace, attirando acquirenti sensibili all’impegno ambientale.
3. **Trasparenza**:
    
    - Una dashboard mostrerà quanto ogni Creator ha contribuito agli EPP grazie al sacrificio della propria quota.
    - Gli acquirenti potranno visualizzare la ripartizione delle royalties di ogni EGI prima dell’acquisto.

---

### **Esempi Pratici**

1. **Configurazione Standard (Default)**:
       - **Creator**: 5%
    - **EPP**: 1%
    - **Natan**: 1%
2. **Configurazione con Sacrificio del Creator**:
    - **Creator**: 3%
    - **EPP**: 3%
    - **Natan**: 1%
3. **Configurazione Minima del Creator**:
    - **Creator**: 1%
    - **EPP**: 5%
    - **Natan**: 1%
...
### **Vantaggi della Policy**

- **Sostenibilità della piattaforma**: Il1% garantisce risorse per mantenere infrastruttura e innovazione.
- **Incentivo etico per i Creator**: La possibilità di sacrificare parte delle royalties aumenta la loro partecipazione attiva agli obiettivi ambientali.
- **Attrattività per gli acquirenti**: Sapere che una quota significativa va agli EPP rende gli EGI più desiderabili, specialmente per un pubblico sensibile ai temi ambientali.
...
Il modulo **Make EGI** permette ai creator di creare e gestire gli **item**, ovvero gli elementi che contengono tutte le informazioni sull'**EGI**.
