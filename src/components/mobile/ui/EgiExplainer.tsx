        ...
        <div className="w-full max-w-[90%] mx-auto mt-8 mb-12 p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
            ...
            <div className="flex items-center justify-between relative">
                ...
                <div className="flex flex-col items-center gap-2 z-10">
                    ...
                    <span className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">{t('explainer.step1')}</span>
                </div>
                ...
                {/* Step 2: Certification (Blockchain + EPP) */}
                <div className="flex flex-col items-center gap-2 z-10">
                    ...
                    <span className="text-[10px] uppercase font-bold text-primary tracking-wider glow-text">{t('explainer.step2')}</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2 z-10">
                    ...
                    <span className="text-[10px] uppercase font-bold text-white tracking-wider">{t('explainer.step3')}</span>
                </div>
            </div>

            <p className="text-center text-gray-400 text-xs mt-6 leading-relaxed px-4 italic">
                {t('explainer.motto')}
            </p>
        </div>
    );
