                    ...
                    <div className="space-y-6">
                        {content.examples.items.map((item, idx) => (
                            <div key={idx} className="flex items-center gap-6 group">
                                <div className="w-52 h-52 shrink-0 rounded-2xl bg-black/50 border border-[var(--border)] overflow-hidden shadow-sm group-hover:scale-105 transition-transform duration-300">
                                    <img
